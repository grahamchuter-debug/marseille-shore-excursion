      ...
      <>
        ...
        <section className="section-padding">
          <div className="container-wide max-w-5xl">
            ...
            {entries.length > 0 && (
              <div className="mt-6 space-y-2 rounded-xl border border-coastal-100 bg-coastal-50/60 p-5 text-sm text-gray-700">
                <p>{PARTIAL_YEAR_SCHEDULE_NOTE}</p>
                {year === 2026 ? (
                  <p>
                    Verified calls currently available begin July 2026. Earlier 2026 dates will be
                    added as they are confirmed.
                  </p>
                ) : null}
                {String(year) === "2028" && PUBLISH_2028 && FUTURE_2028_SCHEDULE_NOTE ? (
            ...
            {entries.length === 0 && (
              <div className="mt-6 rounded-xl border border-amber-200 bg-amber-50 p-6">
                <p className="font-medium text-amber-950">
                  No ships are listed for this schedule period yet
                </p>
                <p className="mt-2 text-sm text-amber-900">
                  We are importing verified {year} ship calls for {port.name}. Check back soon or
