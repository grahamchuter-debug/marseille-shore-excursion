...
export function ShipScheduleHubView({ port }: { port: ShipSchedulePort }) {
  ...
  return (
    <>
      ...
      {!hasData && (
        <div className="mb-8 rounded-xl border border-amber-200 bg-amber-50 p-6">
          ...
          <p className="mt-2 text-sm text-amber-900">
            ...
            <Link href="/port-guide" className="font-medium underline">
              cruise port guide
            </Link>{" "}
            for planning.
          </p>
      ...
      <div className="mb-8 space-y-2 rounded-xl border border-coastal-100 bg-coastal-50/60 p-5 text-sm text-gray-700">
        ...
        <p>
          Times and dates are indicative. Always confirm with your cruise line before booking
          excursions or transfers.
        </p>
      </div>
      ...
      <section className="mb-12 grid gap-4 sm:grid-cols-2">
        <div>
          ...
          <input
            ...
            placeholder="e.g. MSC Meraviglia"
