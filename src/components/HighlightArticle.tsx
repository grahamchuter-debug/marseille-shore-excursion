...
export function HighlightArticle({ page }: { page: AttractionPage }) {
  ...
  return (
    <>
      ...
      />
      <PhotoHeroBand image={image} eyebrow="Marseille for Cruise Passengers" title={page.title} subtitle={page.tagline} compact />
      ...
      <section className="section-padding">
        <div className="container-wide max-w-4xl">
          ...
          {related.length > 0 && (
            <div className="mt-12">
              <h2 className="section-title text-2xl mb-6">More Marseille guides</h2>
          ...
          <div className="mt-12">
            <FAQSection faqs={page.faqs} title={`${page.attractionName} — FAQs`} />
          </div>
          <div className="mt-12">
            <PlanningLinks />
          </div>
